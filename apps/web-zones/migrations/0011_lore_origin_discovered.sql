...
--
-- 'translated' is carried over rather than reintroduced: the live constraint already has
-- it, and a rewrite naming only 0006's three values would outlaw every translated row.
--
