-- How far along a section's data is, as one comparable string. Quests.
--
...
-- uses (lib/quests/catalogue.ts): an edit or a new take inserts a row so the highest id
