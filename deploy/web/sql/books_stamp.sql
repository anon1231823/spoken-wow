-- How far along a section's data is, as one comparable string. Books.
--
...
-- uses (lib/books/catalogue.ts): an edit or a new take inserts a row so the highest id
