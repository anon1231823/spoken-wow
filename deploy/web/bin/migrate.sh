...
#
# Usage: migrate.sh /srv/spoken/releases/20260727-2143-a1b2c3d
#
...
if [ -z "${DATABASE_URL:-}" ] && [ -f "${SPOKEN_ROOT:-/srv/spoken}/shared/app.env" ]; then
  set -a
  # shellcheck disable=SC1091
  . "${SPOKEN_ROOT:-/srv/spoken}/shared/app.env"
  set +a
fi
