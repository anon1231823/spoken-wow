...
The first time you press Contribute, you can also choose to **gather as you play**: every page Spoken has no voice for is kept quietly, and you send them all at once by uploading `SavedVariables/SpokenPlayer.lua` at spoken.rusty.one/contribute. `/spoken share` shows the steps again, and **Gather missing lines in the background** in the Spoken Player settings turns it off.
