...
L.OPT_VOICE_LANGUAGE_TIP = "Which language's sound pack to speak in. Follow Client uses the language your game client runs in. A language is only heard if a sound pack recorded in it is installed."
