...
L = {
    ...
    OPT_HIDE_ACTIONS = "Hide the buttons on the player",
    OPT_HIDE_ACTIONS_TIP = "The Report icon, and anything else an addon puts on the player. What they do is always reachable elsewhere.",
