...
function QuestOverlayUI:CreatePlayButton(questID)
    ...
    playButton:SetNormalTexture([[Interface\AddOns\VoiceOverRedux\Textures\QuestLogPlayButton]])
    playButton:SetDisabledTexture([[Interface\AddOns\VoiceOverRedux\Textures\QuestLogPlayButton]])
