...
### A language is hidden until it is finished
...
table is present. `ready` is all three, and the switcher only offers languages
that are ready **and** whose script the client can draw — `UI/TextView.lua` takes
